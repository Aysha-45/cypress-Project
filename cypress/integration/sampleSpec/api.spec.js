...
describe("Transit API test", function () {
                ...
                api.tokenAuthentication(
                    ...
                    .then((token) => {
                        api.addContact(tenant, token, payload)
                            ...
                            .then((response) => {
                                let contactId = response.body.id;
                                api.deleteContact(tenant, token, "").then(
                                    (response) => {
                                        cy.log(response);
                                        expect(response.status).eq(400);
    ...
    describe("Messages", () => {
        ...
        describe("Unauthorized response", () => {
            ...
            it("Restore te Message Threads - API - Unauthorized", () => {
                api.tokenAuthentication(
                    tenant,
                    testData.tenantManager,
                    testData.password
        ...
        describe("Bad request", () => {
            ...
            it.skip("Restore te Message Threads - API - Bad request", () => {
